...
- Validate the examples manifest: `python /home/hex/Project/References/docs/ai-agent-docs/examples/validate-manifest.py`
...
- `docs/in-depth-overview/implementers-reference.md`

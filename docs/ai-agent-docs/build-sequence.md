...
- Treat `docs/ai-agent-docs/*.md` and `docs/ai-agent-docs/compliance-matrix.md` as the build authority.
...
- Audit the codebase using only `docs/ai-agent-docs/*.md` and `docs/ai-agent-docs/compliance-matrix.md`.

...
- `docs/in-depth-overview/principles.md`
- `docs/in-depth-overview/foundation-verification.md`
- `docs/in-depth-overview/lockin-gate.md`
- `docs/in-depth-overview/lockin-audit.md`
- `docs/in-depth-overview/zero-lockin-checklist.md`

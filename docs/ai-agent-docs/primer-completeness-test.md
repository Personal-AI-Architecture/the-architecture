...
- Start with `docs/ai-agent-docs/index.md`.
- Read the relevant component primer, contract docs, and `accepted-mvp-limits.md`.
- Select applicable matrix rows from `docs/ai-agent-docs/compliance-matrix.md`.

### 3. Run A Primer-Only Audit

- Follow `docs/ai-agent-docs/primer-audit-playbook.md`.
...
Expected Primer File: docs/ai-agent-docs/memory.md
...
Primer Citation: docs/ai-agent-docs/gateway.md
Matrix ID: G-04
...
- `docs/ai-agent-docs/review-checklists/engine-review.md`
- `docs/ai-agent-docs/review-checklists/security-review.md`

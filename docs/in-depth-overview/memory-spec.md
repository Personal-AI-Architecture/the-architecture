...
See [memory-as-platform.md](./memory-as-platform.md) for the full argument on why memory is the platform, and [memory-tool-completeness.md](./memory-tool-completeness.md) for the proof that this binary makes the architecture complete.
